...
AEGIS shows the *same* live physics through four layers of abstraction. Press `F3` (or click **Mode: …** in the top-right) to cycle between them. Your choice persists across reloads.
